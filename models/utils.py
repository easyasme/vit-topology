...
from config import IMG_SIZE, POS_EMB_FLAG
...
def get_model(name, dataset):
    ...
    elif name=='vit_b16' and dataset=='imagenet':
        print("\n Fetching ViT B16")
        net = VTransformerB16(num_classes=10, pretrained=True, input_size=IMG_SIZE, pos_emb_flag=POS_EMB_FLAG)
    elif name=='vit_b32' and dataset=='imagenet':
        print("\n Fetching ViT B32")
        net = VTransformerB32(num_classes=10, pretrained=True, input_size=IMG_SIZE, pos_emb_flag=POS_EMB_FLAG)
    elif name=='vit_l16' and dataset=='imagenet':
        print("\n Fetching ViT L16")
        net = VTransformerL16(num_classes=10, pretrained=True, input_size=IMG_SIZE, pos_emb_flag=POS_EMB_FLAG)
    elif name=='vit_l32' and dataset=='imagenet':
        print("\n Fetching ViT L32")
        net = VTransformerL32(num_classes=10, pretrained=True, input_size=IMG_SIZE, pos_emb_flag=POS_EMB_FLAG)
