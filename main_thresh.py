...
if args.build_graph:
    ...
    os.system('python ./build_graph_w_thresh.py --save_path '+SAVE_PATH+'/'+args.net+'/'+' --net '+args.net+' --dataset '+args.dataset+' --epochs '+args.epochs_test+' --iter '+str(args.iter))

if args.comp_topo:
    visible_print('Computing topology')
    os.system('python ./comp_top_thresh.py --save_path '+SAVE_PATH+'/'+args.net+'/'+' --net '+args.net+' --dataset '+args.dataset+' --epochs '+args.epochs_test+' --iter '+str(args.iter))